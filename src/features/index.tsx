...
const ItemsRenderer = ({
    ...
    return (
        <div className="w-full h-full">
            {type === "flex" && (
                <Droppable
                    className={`p-2 w-full h-full border border-dashed bg-white ${activeId === id && "border-green-500 border-2"
                        }`}
                    columns={columns}
                    rows={rows}
                    rowspan={rowspan}
            ...
            {type === "grid" && (
                <Droppable
                    className={`p-2 min-h-12 w-full h-full border border-dashed bg-white ${activeId === id && "border-green-500 border-2"
                        }`}
                    columns={columns}
                    rows={rows}
                    rowspan={rowspan}
            ...
            {type === "content" && (
                <div
                    className={`p-2 border h-full border-dashed ${activeId === id && "border-2 border-green-500"
